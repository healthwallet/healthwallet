    ...
    if (isDefault) {
        ...
        if (toolbarHTML) {
            ...
            containerHTML.prepend("<div class='" + PAPAYA_TOOLBAR_CSS + "' id='" +
                PAPAYA_DEFAULT_TOOLBAR_ID + "' style='display: none;'></div>");
        }

        if (viewerHTML) {
            viewerHTML.addClass(PAPAYA_VIEWER_CSS);
        } else {
            //添加View的html元素@@songjing@@
         /*   $("<div class='" + PAPAYA_VIEWER_CSS + "' id='" +
             PAPAYA_DEFAULT_VIEWER_ID + "'></div>").insertAfter($("#" + PAPAYA_DEFAULT_TOOLBAR_ID));*/
            $('.mprImgBox').append("<div class='" + PAPAYA_VIEWER_CSS + "' id='" +
                PAPAYA_DEFAULT_VIEWER_ID + "' ></div>");
        }
        ...
        if (displayHTML) {
            ...
            $("<div class='" + PAPAYA_DISPLAY_CSS + "' id='" +
                PAPAYA_DEFAULT_DISPLAY_ID + "' style='display: none;'></div>").insertAfter($("#" + PAPAYA_DEFAULT_VIEWER_ID));
        }
        ...
        if (!params || (params.kioskMode === undefined) || !params.kioskMode) {
            ...
            "' class='" + PAPAYA_TOOLBAR_CSS + "' style='display: none;'></div>");
        }
        ...
        * */
        containerHTML.append("<div id='" + (PAPAYA_DEFAULT_DISPLAY_ID + index) +
            "' class='" + PAPAYA_DISPLAY_CSS + "' style='display: none;'></div>");

        /*
        * 调节图像各个切面的上一页，下一页*/
        //控制按钮显示类型
         params.showControlBar=true;
          params.showControls=true;//sj add
        ...
        if ( params && params.showControlBar && ((params.showControls === undefined) || params.showControls)) {
            containerHTML.append(
                ...
                "<span class='" + PAPAYA_CONTROL_BAR_LABELS_CSS + "'>Axial: </span>" + " <button type='button'   class=' AxialAdd " + PAPAYA_CONTROL_INCREMENT_BUTTON_CSS + "'>+</button>" + " <button type='button' class='AxialSub " + PAPAYA_CONTROL_INCREMENT_BUTTON_CSS + "'>-</button> " +
                "</div>" +

                "<div id='" + (PAPAYA_DEFAULT_SLIDER_ID + index) + "coronal" + "' class='" + PAPAYA_SLIDER_CSS + " " + PAPAYA_CONTROL_DIRECTION_SLIDER + "'>" +
                "<span class='" + PAPAYA_CONTROL_BAR_LABELS_CSS + "'>Coronal: </span>" + " <button type='button'   class='CoronalAdd " + PAPAYA_CONTROL_INCREMENT_BUTTON_CSS + "'>+</button>" + " <button type='button' class='CoronalSub " + PAPAYA_CONTROL_INCREMENT_BUTTON_CSS + "'>-</button> " +
                "</div>" +

                "<div id='" + (PAPAYA_DEFAULT_SLIDER_ID + index) + "sagittal" + "' class='" + PAPAYA_SLIDER_CSS + " " + PAPAYA_CONTROL_DIRECTION_SLIDER + "'>" +
                "<span class='" + PAPAYA_CONTROL_BAR_LABELS_CSS + "'>Sagittal: </span>" + " <button type='button'   class='SagittalAdd " + PAPAYA_CONTROL_INCREMENT_BUTTON_CSS + "'>+</button>" + " <button type='button' class='SagittalSub " + PAPAYA_CONTROL_INCREMENT_BUTTON_CSS + "'>-</button> " +
                "</div>" +
        ...
        // if (params   || params.showControls)
         {

            containerHTML.append("<button type='button' id='"+ (PAPAYA_CONTROL_MAIN_INCREMENT_BUTTON_CSS + index) + "' class='" + PAPAYA_CONTROL_MAIN_INCREMENT_BUTTON_CSS + "' style='display: none;'>+</button> ");
            containerHTML.append("<div type='button' id='"+ ('papaya-main-scrollbox' + index) + "' class='papaya-main-scrollbox' style='display: none;'>+</div> ");
            containerHTML.append("<button type='button' id='"+ (PAPAYA_CONTROL_MAIN_DECREMENT_BUTTON_CSS + index) + "' class='" + PAPAYA_CONTROL_MAIN_DECREMENT_BUTTON_CSS + "' style='display: none;'>-</button> ");
            containerHTML.append("<button type='button' id='"+ (PAPAYA_CONTROL_MAIN_SWAP_BUTTON_CSS + index) + "' class='" + PAPAYA_CONTROL_MAIN_SWAP_BUTTON_CSS + "' style='display: none;'>Swap View</button> ");
            containerHTML.append("<button type='button' id='"+ (PAPAYA_CONTROL_MAIN_GOTO_CENTER_BUTTON_CSS + index) + "' class='" + PAPAYA_CONTROL_MAIN_GOTO_CENTER_BUTTON_CSS + "' style='display: none;'>Go To Center</button> ");
            containerHTML.append("<button type='button' id='"+ (PAPAYA_CONTROL_MAIN_GOTO_ORIGIN_BUTTON_CSS + index) + "' class='" + PAPAYA_CONTROL_MAIN_GOTO_ORIGIN_BUTTON_CSS + "' style='display: none;'>Go To Origin</button> ");
...
papaya.Container.buildAllContainers = function () {
    console.log("----------buildAllContainers------------");
    ...
    if (defaultContainer.length > 0) {
        console.log("________________01___________");
        ...
        console.log("________________02___________");
...
papaya.Container.prototype.getViewerDimensions = function () {
    ...
    ///*@@songjing@@*/
    width=$('.mprImgBox').width();
    height=$('.mprImgBox').height();
    return [width, height];
};
...
papaya.Container.prototype.resizeViewerComponents = function (resize) {
   ...
   /* console.log($('.mprImgBox').width(),$('.mprImgBox').height());
    console.log(dims);*/
  ...
  /*  this.viewerHtml.css({width: dims[0] + "px"});
    ...
    if (this.showControls && this.showControlBar) {
        ...
        /*@@songjing@@*/
        $('.papaya-kiosk-controls').hide();//隐藏自带按钮栏
        return;//sj add
...
papaya.Container.prototype.buildToolbar = function () {
    ...
    toolbarObj = this.toolbar;//sj add
