...
//手机版还好，没那么多逻辑
//与dvStruct交互  关键有 dvStruct.playSpeed   dvStruct.fun.play  dvStruct.fun.stop
unit.speedSlider = {
    ini:function(){
        ...
        rangebar.noUiSlider.on('update', function( values, handle ) {
            ...
            if(dvStruct.isplaying){
                ...
                dvStruct.fun.stop();dvStruct.fun.play();
            }
        });
    },
    ...
    show:function(){
        $(unit.mask.getMask()).on('touchstart',function(e){
            unit.speedSlider.hide();e.preventDefault();
        });
