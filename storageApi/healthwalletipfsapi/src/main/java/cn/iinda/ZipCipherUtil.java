...
public class ZipCipherUtil {
     ...
     *            密钥
     */
    public void encryptStreamFile(InputStream srcStream, OutputStream destStream, String keyStr) throws Exception {
        // 对文件加密
        new CipherUtil().encryptStream(srcStream, destStream, keyStr);
    }
    /**
     * 对目录srcFile下的所有文件目录进行先压缩后加密,然后保存为destfile
     *
     ...
     *            密钥
     */
    public InputStream decryptStream(InputStream srcStream, String keyStr) throws Exception {
        // 先对文件解密
        return new CipherUtil().decryptStream(srcStream, keyStr);
    }
    /**
     * 对流srcStream进行解密到流destStream下
     *
     ...
     *            密钥
     */
    public InputStream encryptStream(InputStream srcStream, String keyStr) throws Exception {
        // 先对文件解密
        return new CipherUtil().encryptStream(srcStream, keyStr);
    }
